...
2. [done] Kyubinn Kim: Merged i18n Messages class with EN/KO/ZH locale suport. (#49)
...
8. [planned] Wire ChessClock timout into Game for the timeout loss win condtion.
9. [planned] Finish remaining piece BDDs (Rook, Queen, King, Pawn). Checkmate detection depnds on these being done.
10. [planned] Run PIT and JaCoCo for the team test quality report next week if theres time.
